    ...
    class CPlayerCountPatch : public IPatchRegistrar {
        public:
            ...
            virtual void register_patches(CMPPatchPlugin& plugin) override {
                ...
                plugin.register_patch<CSeqPatch>(CServerGameClients_GetPlayerLimits + 0x07, new SEQ_HEX("c7 00 01 00 00 00"), new SEQ_HEX("c7 00 $1 00 00 00", { &m_MaxPlayers }));
                plugin.register_patch<CSeqPatch>(CServerGameClients_GetPlayerLimits + 0x11, new SEQ_HEX("c7 00 01 00 00 00"), new SEQ_HEX("c7 00 $1 00 00 00", { &m_MaxPlayers }));
                plugin.register_patch<CSeqPatch>(CServerGameClients_GetPlayerLimits + 0x31, new SEQ_HEX("b8 02 00 00 00"), new SEQ_HEX("b8 $1 00 00 00", { &max_players_p1 }));
                ...
                plugin.register_patch<CSeqPatch>(FUNC_slotcount_adj + 0x701, new SEQ_HEX("be 01 00 00 00"), new SEQ_HEX("be $1 00 00 00", { &m_MaxPlayers })); //SP maps
                plugin.register_patch<CSeqPatch>(FUNC_slotcount_adj + 0x6a2, new SEQ_HEX("be 02 00 00 00"), new SEQ_HEX("be $1 00 00 00", { &m_MaxPlayers })); //MP maps
                ...
                plugin.register_patch<CSeqPatch>(CMatchTitleGameSettingsMgr_InitializeGameSettings + 0x172, new SEQ_HEX("b8 01 00 00 00"), new SEQ_HEX("b8 $1 00 00 00", { &m_MaxPlayers }));
            }
